...
class Prompts(Base):
    __tablename__ = 'sls_outgoing_tg_prompts'
    __table_args__ = {"schema": "telegram_service"}
...
class Chat_messages(Base):
    __tablename__ = 'sls_outgoing_tg_chat_messages'
    __table_args__ = {"schema": "telegram_service"}
...
class Arrangements(Base):
    __tablename__ = 'sls_outgoing_tg_arrangements'
    __table_args__ = {"schema": "telegram_service"}
