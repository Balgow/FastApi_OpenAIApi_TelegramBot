...
# create list of descriptions for each endpoint, then add to each endpoint
# write detailed description for each endpoint so that it can be used in the documentation
# description must be understandable by a non-technical person
descriptions = {
    '/': 'Home',
...
async def home(db: Session = Depends(get_db)):
    return {'msg':'You are in the email akt outgoing api'}
